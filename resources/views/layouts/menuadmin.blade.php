            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/documentos/report') }}" class="nav-link">
                                <i class="nav-icon fas fa-copy"></i>
                                <p>Reporte documentación</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('/psicologico') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Psicológico</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/psicologicosegundo') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Segundo psicológico</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/psicometrico') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Psicometrico</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/psicometricosegundo') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Segundo psicometrico</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
